...
public class SyncBuffer_transform_noScale  
{
    #region Inspector
    /// <summary>
    ...
    public virtual Vector3 PositionNoErrorCorrection
    {
        get
        {
            ...
            return _keyframes[0].Position + _keyframes[0].Velocity_Scale * _playbackTime;// + 0.5f * _keyframes[0].Acceleration * _playbackTime * _playbackTime;
        }
    }
    ...
    /// </summary>
    public virtual Vector3 Velocity_Scale
    {
        get
        {
            if (!HasKeyframes)
            ...
            return _keyframes[0].Velocity_Scale;// + _keyframes[0].Acceleration * _playbackTime;
        }
    }
    ...
    public virtual void AddKeyframe(float interpolationTime, Vector3 position, Quaternion rotation = default(Quaternion), Vector3? velocity_s = null)
    {
        ...
        var keyframe = new Keyframe
        {
            ...
            Position = position,
            Velocity_Scale = velocity_s ?? calculatedVelocity,
        ...
        lastReceivedKeyframe.Velocity_Scale = calculatedVelocity;
